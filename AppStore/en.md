# App Store Connect — English (Primary language: English, U.S.)
...
*(Comma-separated, no spaces. Do not repeat the app name or category.)*

```
bill,split,receipt,scan,share,expense,friends,dinner,restaurant,tax,service,tip,group,fair,egp
```
...
THE MATHS ALWAYS ADDS UP
Money is handled in whole piastres and leftover pennies are handed out one at a time, never rounded away. Each person's share is exact, and the shares always total the bill.

SHARE IN ONE TAP
Send each person their own itemised share, or the whole breakdown, through WhatsApp, Messages or anything else on your phone.

GROUPS AND HISTORY
Save the people you split with often and every new bill starts with them already added. Past bills stay on your phone, ready to reopen and check.

ENGLISH AND EGYPTIAN ARABIC
Switch language in one tap, with full right-to-left layout. The receipt reader handles Arabic receipts and Arabic-Indic numerals too.

CURRENCY CONVERTER
Over 160 currencies for when you're travelling, cached on your device so it still works with no signal, and always dated so you know how current the rate is.

DON'T FORGET YOUR THINGS
Keep a list of what you always leave behind — bottle, ID, keys — and get a reminder as you head out the door.

PRIVATE BY DESIGN
No account. No sign-up. No analytics, no advertising, no tracking. Your bills live on your phone and nowhere else.
```
...
| Field | Value |
|---|---|
| Support URL | `https://mariameskander.github.io/Split-me-docs/` |
| Marketing URL | *(leave blank, or the same as Support)* |
| Privacy Policy URL | `https://mariameskander.github.io/Split-me-docs/privacy.html` |
